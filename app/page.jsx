        ...
        <section id="projects" className="py-3 md:py-6 lg:py-12">
          <div className="container">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <ProjectCard title="TIC TAC TOE GAME " description="Developed a professional WordPress website for RENcomm, showcasing their business services with mobile responsiveness, modern layout, and on-page SEO best practices for visibility and performance." image="/projectimg/tic-tact-toe.jpg" link="https://game-tic-tac-eto.vercel.app/" tags={["HTML", "CSS", "JavaScript"]}/>
