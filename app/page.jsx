      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          <Link className="p-4 flex items-center space-x-2" href="/">
            <img src="/sohil-profile-pic.png" alt="Sohil Khan Profile Picture" className="w-10 h-10 rounded-full object-cover" />
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-6 text-center">
              <div className="space-y-3">
                <h1 className="text-4xl font-bold sm:text-5xl md:text-6xl lg:text-7xl text-blue-600">MERN STACK DEVELOPER</h1>
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Hi, I'm SOHIL KHAN, an aspiring MERN Stack Developer with a passion for building robust, scalable, and user-friendly web applications. 
                  I thrive on creating dynamic and responsive solutions and am seeking opportunities to leverage my expertise and grow within the web development industry.
                </p>
              </div>
        ...
        <section id="projects" className="py-3 md:py-6 lg:py-12">
          <div className="container">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <ProjectCard title="E-coomerce web for Hand made products" description="A fully responsive and SEO-optimized Next.js website built for a professional marriage counseling service. The site includes custom layouts, optimized performance, and on-page SEO with a 100/100 Lighthouse score." image="/projectimg/project3-img.png" link="https://anmol-web-app.web.app/" tags={["Next Js", "Responsive Design", "On-Page SEO"]}/>
              <ProjectCard title="My PortFolio web app" description="A responsive and SEO-friendly Next.js website created for a mental health and therapy services provider. Built with user-focused UI/UX, optimized loading performance, and strong on-page SEO implementation." image="/projectimg/project2-img.jpg" link="https://portfolio-rho-silk-yj4odgsk1m.vercel.app/" tags={["Next js", "Responsive Design", "SEO", "UI/UX"]}/>
              <ProjectCard title="TIC TAC TOE GAME " description="Developed a Tic Tac Toe game using HTML, CSS, and JavaScript, featuring interactive two-player gameplay, responsive UI, and clean code structure for better performance and user engagement" image="/projectimg/tic-tact-toe.jpg" link="https://game-tic-tac-eto.vercel.app/" tags={["HTML", "CSS", "JavaScript"]}/>
              <ProjectCard title="LiveCure24 Healthcare Website" description="Developed a responsive healthcare service platform using Laravel PHP. Integrated appointment booking, dynamic service management, and implemented on-page SEO to boost online visibility." image="/projectimg/project21-img.jpg" link="https://www.livecure24.com/" tags={["Laravel", "PHP", "Healthcare", "Responsive Design", "SEO"]}/>
              <ProjectCard title="CorpPlace Business Solutions Website" description="Designed and developed a corporate solutions platform using Laravel PHP and Tailwind CSS. Delivered a clean, fully responsive UI with SEO optimization and modular architecture." image="/projectimg/rencom.jpg" link="https://corpplace.com/" tags={["Laravel", "PHP", "Tailwind CSS", "Corporate", "Responsive Design"]}/>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
              <div className="p-6 rounded-lg shadow-md bg-white dark:bg-gray-800 text-center">
                <h3 className="text-xl font-semibold text-blue-600">Frontend Developer Intern</h3>
                <p className="text-gray-600 dark:text-gray-300">AMITKK Digital Solutions | May 2025 – Present</p>
                <p className="mt-3 text-gray-500 dark:text-gray-400">
                  Working as a Frontend Developer focusing on building dynamic, scalable, and responsive web applications.  
                  The projects I have contributed to are listed in the Projects section above.
                </p>
              </div>

            
              <div className="p-6 rounded-lg shadow-md bg-white dark:bg-gray-800 text-center">
                <h3 className="text-xl font-semibold text-blue-600">UI/UX Intern</h3>
                <p className="text-gray-600 dark:text-gray-300">Oasis Infobyte | Nov 2024 – Dec 2024</p>
                <p className="mt-3 text-gray-500 dark:text-gray-400">
                  Worked on creating user-friendly UI/UX designs and implemented responsive layouts.  
                  Focused on enhancing usability and improving visual design for multiple web projects.
                </p>
              </div>
            </div>
          </div>
